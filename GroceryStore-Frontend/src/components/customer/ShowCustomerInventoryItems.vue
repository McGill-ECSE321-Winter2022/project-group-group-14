<template>
  ...
  <div class="grid-container">
      ...
      <ul class="item">
                ...
                <li class="info" v-if="newGroceryOrder.orderId">
                  email : {{newGroceryOrder.orderId}}

                </li>

                <li class="info" v-if="newGroceryOrder.orderId">
                   groceryOrderId : {{newGroceryOrder.orderId}}
                </li>
                ...
                <li class="info">
                  <select class="dropdown-list" id="sel1" name="sellist1">
